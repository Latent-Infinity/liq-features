...
class TestAbnormalTurnover:
    ...
    def test_abnormal_turnover_compute(self, sample_ohlc_df_large: pl.DataFrame) -> None:
    ...
    def test_abnormal_turnover_spike_detection(self) -> None:
        ...
        n = 50
        timestamps = [datetime(2024, 1, 1, i // 24, i % 24, 0, tzinfo=UTC) for i in range(n)]
        volumes = [1000.0] * n
...
class TestNormalizedVolume:
    ...
    def test_normalized_volume_compute(self, sample_ohlc_df_large: pl.DataFrame) -> None:
    ...
    def test_normalized_volume_multiple_windows(self, sample_ohlc_df_large: pl.DataFrame) -> None:
